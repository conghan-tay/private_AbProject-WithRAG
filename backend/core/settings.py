...
ASKVAULT_RAG_E2E_FAKE = env_bool('ASKVAULT_RAG_E2E_FAKE', False)
if ASKVAULT_RAG_E2E_FAKE and not DEBUG:
    raise ValueError('ASKVAULT_RAG_E2E_FAKE is only allowed when DJANGO_DEBUG=True')
